...
const rateSeller = async (req, res) => {
    ...
    const buyerId = req.user.userId; // Assumes auth middleware sets `user` on request
    ...
    try {
        ...
        const existing = await prisma_1.default.rating.findFirst({
